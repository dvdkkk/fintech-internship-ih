...
export default function App() {
  ...
  const navItems = [
    { name: "풀스택 개발자", href: "https://fintech-internship-fullstack-ih.vercel.app", external: true },
    { name: "서비스 기획자", href: "https://fintech-internship-serviceplanning-ih.vercel.app", external: true },
            ...
            <div className="grid md:grid-cols-2 gap-8 divide-x divide-gray-200">
              {[
                ...
                },
                {
                  ...
                  href: "https://fintech-internship-serviceplanning-ih.vercel.app"
                }
              ].map((item, idx) => (
                <motion.a 
                  key={idx} 
